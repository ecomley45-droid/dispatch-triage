...
function seedDemo() {
  ...
  const cust = { id: randomUUID(), org_id: orgId, name: 'Riverside Dental Partners', billing_email: 'ap@riverside-dental.example', phone: '(555) 210-4488', billing_address: '900 Riverside Blvd, Suite 200', payment_terms: 'net_30', po_required: true, status: 'active', notes: 'Multi-location group; PO required on all work.', created_by: 'dev@localhost', created_at: now(), updated_at: now() };
