...
import { CAPABILITIES, PRESET_ROLES, PAGE_KEYS, presetPerms, sanitizePerms } from './permissions.js';
...
export async function resolveRolePerms(orgId, roleKey) {
  ...
  if (preset) return { pages: new Set(preset.pages), caps: new Set(preset.caps), readPages: new Set(PAGE_KEYS) };
