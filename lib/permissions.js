...
export const FEATURE_FLAGS = [
  ...
  { key: 'items', label: 'Inventory / parts & item costs', group: 'Records', pages: ['items'], caps: ['items:write', 'usage:write'] },
  // --- Field operations ---
  { key: 'work_orders', label: 'Work orders & job management', group: 'Field operations', pages: ['work_orders'], caps: ['work_orders:write', 'wo_lines:write'], requires: ['customers'] },
