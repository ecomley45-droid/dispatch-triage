...
const DEVICE_CATALOG = {
  ...
  'galaxy-s26-ultra': {
    ...
    outerRadiusClass: 'rounded-lg', screenRadiusClass: 'rounded', bezelWidth: 7,
  ...
  'galaxy-s26': {
    ...
    outerRadiusClass: 'rounded-[40px]', screenRadiusClass: 'rounded-[34px]', bezelWidth: 9,
    notchType: 'hole-punch-center', osType: 'android', timeString: '10:08',
    sideButtons: { left: [], right: ['vol-up', 'vol-down', 'power'] },
  },
  'galaxy-zfold8-ultra': {
    name: 'Galaxy Z Fold 8 Ultra', category: 'foldable',
    dpr: 3, outerRadiusClass: 'rounded-lg', screenRadiusClass: 'rounded', bezelWidth: 10,
    unfolded: { width: 1052, height: 956, tagline: '8.0" 11:10 Main Display (Unfolded)', bezelWidth: 10, notchType: 'hole-punch-top-right', defaultScale: 0.65 },
    folded: { width: 410, height: 956, tagline: '6.5" 21:9 Cover Display (Folded)', bezelWidth: 8, notchType: 'hole-punch-center', defaultScale: 0.65 },
  ...
  'galaxy-zfold8': {
    ...
    dpr: 3, outerRadiusClass: 'rounded-lg', screenRadiusClass: 'rounded', bezelWidth: 10,
    unfolded: { width: 1080, height: 810, tagline: '7.6" 4:3 Main Display (Unfolded)', bezelWidth: 10, notchType: 'hole-punch-top-right', defaultScale: 0.65 },
    folded: { width: 506, height: 810, tagline: '5.5" 16:10 Cover Display (Folded)', bezelWidth: 9, notchType: 'hole-punch-center', defaultScale: 0.65 },
    osType: 'android', timeString: '10:08',
    sideButtons: { left: [], right: ['vol-up', 'vol-down', 'power'] },
  },
  'galaxy-s25-ultra': {
